...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['company_id'], ['companies.id'], name='contacts_company_id_fkey'),
    sa.ForeignKeyConstraint(['genre_id'], ['genres.id'], name='contacts_genre_id_fkey'),
    sa.ForeignKeyConstraint(['position_id'], ['positions.id'], name='contacts_position_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['category_id'], ['categories.id'], name='companies_category_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='companies_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_index('ix_companies_id', 'companies', ['id'], unique=False)
    op.create_table('contacts_genres',
    ...
    sa.ForeignKeyConstraint(['Contact ID'], ['contacts.id'], name='contacts_genres_Contact ID_fkey'),
    sa.ForeignKeyConstraint(['Genre ID'], ['genres.id'], name='contacts_genres_Genre ID_fkey'),
    ...
    sa.Column('Genre ID', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['Genre ID'], ['genres.id'], name='song_genres_Genre ID_fkey'),
    sa.ForeignKeyConstraint(['Song ID'], ['songs.id'], name='song_genres_Song ID_fkey'),
    ...
    sa.Column('Contact ID', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('Song ID', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['Contact ID'], ['contacts.id'], name='sent_Contact ID_fkey'),
